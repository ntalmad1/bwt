...
/**
 * Simple statistics information that can be created when parsing a java source
 * code using the {@link de.java2html.javasource.JavaSourceParser}.
 * 
...
public class JavaSourceStatistic
{
	...
	public String getScreenString (String lineSeparator)
	{
		...
		result.append("   Lines total: " + lineCount + "  Code: " + codeLineCount + "  Comments: " + commentLineCount + "  Empty: " + emptyLineCount + lineSeparator);
