...
/**
 * This class represents java source code in a parsed, but still flat style. It
 * contains the raw text along with an array of source type entries (
...
public class JavaSource
{
	...
	/**
	 * Flags for every character in the source code telling the type.
	 */
	...
	{
		/*
		 * output format (example): Lines total: 127 Code: 57 Comments: 16
		 * Empty: 54 3164 Characters, maximum line length: 95
		 */
